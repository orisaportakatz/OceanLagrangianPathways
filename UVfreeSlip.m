function [U_final, V_final] = UVfreeSlip(Uin, Vin, dim)
...
for i = 1:size(Uin,dim+1)
    ...
    if dim == 3
        ...
        %GroundInd values of them and their 8 nearest neighbors is 8:
        ...
        %Tangenty; ???
        velLength = U1_switch .* Tangenty + V1_switch .* Tangentx;
        ...
        U1_new = velLength .* Tangenty;
        V1_new = velLength .* Tangentx;
